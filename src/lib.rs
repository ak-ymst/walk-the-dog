...
pub fn main_js() -> Result<(), JsValue> {
    ...
    sierpinki(&context, [(300.0, 0.0),(0.0, 600.0),(600.0, 600.0)],(0, 255, 0), 5);

    Ok(())
}

fn sierpinki(context: &web_sys::CanvasRenderingContext2d, points: [(f64, f64); 3], color: (u8,u8,u8), depth: u8) {
